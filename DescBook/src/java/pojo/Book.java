...
public class Book implements java.io.Serializable {
    ...
    public Book(String title, String author, String language, String publisher, String publishCountry, String category, int totalPages, String estPrice) {
        this.title = title;
        this.author = author;
    ...
    public Book(String title, String author, String language, String publisher, String publishCountry, String category, int totalPages, String estPrice, String imgCover, Set bookmarks) {
        this.title = title;
        this.author = author;
        this.language = language;
        this.publisher = publisher;
